<%@ Page Title="用户表" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="FwjSoft.Web.UserInfo.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="UserName" HeaderText="用户名称" SortExpression="UserName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="PassWord" HeaderText="用户密码" SortExpression="PassWord" ItemStyle-HorizontalAlign="Center"  /> 
