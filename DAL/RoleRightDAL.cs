...
namespace FwjSoft.DAL
{
	...
	public partial class RoleRightDAL
	{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select RoleRightId,RoleId,MenuId ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" RoleRightId,RoleId,MenuId ");
			strSql.Append(" FROM RoleRight ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.RoleRightId desc");
			}
			strSql.Append(")AS Row, T.*  from RoleRight T ");
